from helphub.helphub_core.operators import (SearchOp, QueryLogs, Workflow, TerminateOp,
                                            ToolCall)
from helphub.helphub_core import build_operator

@build_operator
class GetTasksLogError(SearchOp):
    PROMPT = {"desc": "Confirms the request for get tasks have some error",
              "examples":[
                  ("Error in get task for user: 1b492058-2c9b-4593-817d-6b48ac4f1db9", "user_id=1b492058-2c9b-4593-817d-6b48ac4f1db9"),
                  ("Error in get task for user: 1b492058-2c9b-4593-817d-6b48ac4f1dtr", "user_id=1b492058-2c9b-4593-817d-6b48ac4f1dtr")
              ]}
...
get_tasks_logs = QueryLogs(name="get_tasks_logs", corr_id="$_helphub_corr_id")
get_tasks_req = GetTasksLogError()
...
get_tasks_workflow>>get_tasks_logs>>get_tasks_req>>end_get_tasks
...
get_reassign_api_logs = QueryLogs(name="get_reassign_api_logs",query="Reassign request received for task:(.*) from user: (.*) to new_user:$_helphub_sub")
reassign_tasks_req = ReassignRequest()
get_reassign_tasks_logs = QueryLogs(name="get_reassign_tasks_logs", query="Error occurred while reassigning task: $task_id from user: $from_user_id to new_user:$new_user_id")
...
(reassign_tasks_workflow>>get_reassign_api_logs>>reassign_tasks_req>>
 get_reassign_tasks_logs>>assign_tasks_error>>reassign_tool>>end_reassign_tasks)
